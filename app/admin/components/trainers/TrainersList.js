          ...
          <li key={trainer._id} className="p-6">
            <div className="flex items-start">
              ...
              <button
                ...
                className="flex-shrink-0 ml-4 p-1.5 rounded-full text-gray-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 focus:outline-none transition-colors"
