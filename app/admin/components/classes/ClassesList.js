              ...
              <div className="flex-1 p-4">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="ml-4 p-1.5 rounded-full text-gray-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 focus:outline-none transition-colors"
                ...
                <div className="mt-1 flex items-center text-sm text-gray-500 dark:text-gray-400">
                  ...
                  <span className="font-mono text-xs">/classes/{cls.slug}</span>
                </div>
