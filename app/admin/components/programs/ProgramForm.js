"use client";    //Form to add new programs (left side)
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
      <div className="border-b border-gray-200 dark:border-gray-700 px-6 py-4">
        <h3 className="text-lg font-medium text-gray-900 dark:text-white">Add New Program</h3>
        <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">These programs appear on the website for potential members.</p>
      </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    min="0"
                    step="0.01"
                    value={programData.pricing.walkIn}
                    onChange={handleChange}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    min="0"
                    step="0.01"
                    value={programData.pricing.weekly}
                    onChange={handleChange}
                    className="pl-8 w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-red-500 focus:ring focus:ring-red-500 focus:ring-opacity-50 bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                  />
                </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    min="0"
                    step="0.01"
                    value={programData.pricing.monthly}
                    onChange={handleChange}
                    className="pl-8 w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-red-500 focus:ring focus:ring-red-500 focus:ring-opacity-50 bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                  />
                </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    min="0"
                    step="0.01"
                    value={programData.pricing.annual}
                    onChange={handleChange}
                    className="pl-8 w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-red-500 focus:ring focus:ring-red-500 focus:ring-opacity-50 bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                  />
                </div>
