    ...
    return (
      <div className="p-6" style={{ background: "#141414", border: "1px solid rgba(237,235,230,0.06)" }}>
        <div className="text-center py-8">
          ...
          <p className="mt-4 text-sm" style={{ color: "rgba(237,235,230,0.4)" }}>Loading programs...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="p-8 text-center" style={{ background: "#141414", border: "1px solid rgba(237,235,230,0.06)" }}>
        <div className="flex flex-col items-center justify-center py-8">
          ...
          <p className="text-sm" style={{ color: "rgba(237,235,230,0.4)" }}>No programs added yet</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="overflow-hidden" style={{ background: "#141414", border: "1px solid rgba(237,235,230,0.06)" }}>
      <div className="px-6 py-4" style={{ borderBottom: "1px solid rgba(237,235,230,0.06)" }}>
        <h3 className="text-sm font-bold uppercase tracking-widest" style={{ color: "#EDEBE6" }}>Current Offered Programs</h3>
      </div>

      <div className="px-6 py-4 space-y-3">
        {programs.map((program) => (
          <div key={program._id} className="flex overflow-hidden" style={{ background: "#1A1A1A", border: "1px solid rgba(237,235,230,0.06)" }}>
            {program.image && (
            ...
            <div className="flex-1 p-3">
              <div className="flex items-center justify-between">
                <h4 className="text-sm font-bold" style={{ color: "#EDEBE6" }}>{program.title}</h4>
