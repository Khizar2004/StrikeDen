        ...
        <footer className="bg-secondary-900 text-white py-10">
          <div className="container-padded">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div>
                <h3 className="text-xl font-bold mb-4">Strike Den</h3>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li><a href="/" className="text-secondary-300 hover:text-white transition-colors">Home</a></li>
                  <li><a href="/about" className="text-secondary-300 hover:text-white transition-colors">About</a></li>
                  <li><a href="/classes" className="text-secondary-300 hover:text-white transition-colors">Classes</a></li>
                  <li><a href="/trainers" className="text-secondary-300 hover:text-white transition-colors">Trainers</a></li>
                </ul>
              </div>
              <div>
                <h3 className="text-lg font-medium mb-4">Contact</h3>
                <ul className="space-y-2">
                  <li className="text-secondary-300">+92 82000-60000</li>
                  <li className="text-secondary-300">info@strikeden.com</li>
                  <li className="text-secondary-300">Karachi, Pakistan</li>
                </ul>
              </div>
              <div>
                <h3 className="text-lg font-medium mb-4">Hours</h3>
                <ul className="space-y-2">
                  <li className="text-secondary-300">Mon-Fri: 6am - 10pm</li>
                  <li className="text-secondary-300">Sat: 8am - 8pm</li>
                  <li className="text-secondary-300">Sun: 8am - 6pm</li>
                </ul>
              </div>
            </div>
            <div className="mt-8 pt-8 border-t border-secondary-700 flex flex-col md:flex-row justify-between items-center">
              <p className="text-secondary-400">© {new Date().getFullYear()} Strike Den. All rights reserved.</p>
